...
import 'profile_summary_model.dart';
export 'profile_summary_model.dart';

class ProfileSummaryWidget extends StatefulWidget {
  const ProfileSummaryWidget({super.key});

  static String routeName = 'ProfileSummary';
  static String routePath = '/profileSummary';
...
class _ProfileSummaryWidgetState extends State<ProfileSummaryWidget> {
  late ProfileSummaryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileSummaryModel());
