...
import 'videocalldetails_model.dart';
export 'videocalldetails_model.dart';

class VideocalldetailsWidget extends StatefulWidget {
  const VideocalldetailsWidget({super.key});

  static String routeName = 'videocalldetails';
  static String routePath = '/videocalldetails';

  @override
  State<VideocalldetailsWidget> createState() => _VideocalldetailsWidgetState();
}

class _VideocalldetailsWidgetState extends State<VideocalldetailsWidget> {
  late VideocalldetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VideocalldetailsModel());
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      child: Align(
                        alignment: AlignmentDirectional(0.0, 0.0),
                        child: Text(
                          'Video Call Now ( Start at 10.00 AM )',
                          style:
                              FlutterFlowTheme.of(context).bodyMedium.override(
                                    font: GoogleFonts.mooli(
                                      fontWeight: FontWeight.w600,
